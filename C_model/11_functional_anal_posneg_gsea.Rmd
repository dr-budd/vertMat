...
## save it
# saveRDS(combined_results, file=paste0("dataFiles/11.00_combined_results_homo_posneg_gsea.rds"))

Sys.time()
```

```{r}
# combined_results <- readRDS(paste0("dataFiles/11.00_combined_results_homo_posneg_gsea.rds"))
```
